...
RSpec.describe "MasterDecks", type: :request do
    ...
    it "creates a MasterDeck and redirects to the MasterDeck's page" do
        ...
        expect(response).to redirect_to("/u/#{user.username}/decks/#{master_deck.slug}")
        follow_redirect!
    ...
    it "creates a new branch of the deck and redirects to the new branch" do
       ...
       get "/u/#{user.username}/decks/#{master_deck.slug}"
       expect(response).to render_template(:show)
       ...
       expect(response).to redirect_to("/u/#{user.username}/#{master_deck.slug}/tree/new-branch")
       follow_redirect!
